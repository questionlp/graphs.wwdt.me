...
**Note:** Provisional support for MariaDB Server is only available starting with version 3.7.0 of the Stats Page. Older versions of MariaDB Server are not supported.
