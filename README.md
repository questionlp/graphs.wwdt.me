...
Flask-based web application that serves up graphs based on collected statistics
for the NPR weekly quiz show [Wait Wait... Don't Tell Me!](http://waitwait.npr.org)
