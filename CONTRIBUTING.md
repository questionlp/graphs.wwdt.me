...
Although the default branch for this repository is `main`, all fix and
feature branches should be branched off of the `develop` branch.

Once you have cloned this repository, you can create a new branch off of
`develop` by using the following command:

    git checkout develop; git pull; git branch new-branch
